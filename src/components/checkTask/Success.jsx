...
function Success({cls}) {
  ...
  return (
    ...
    <p class="feedback-message">Задание успешно выполнено. ✅
Решение полностью соответствует требованиям и демонстрирует правильное понимание поставленной задачи.</p>
